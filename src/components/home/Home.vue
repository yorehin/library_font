<template>
<div>
  <img src="../../assets/img/home/轮播图1.png" height="924" width="1920"/>
  ...
  <div id="about">
    ...
    <div class="newProduct1" style="color: black">
      <div class="newProduct2" style="color: black; border-top: 1px solid black;" >
        About us
      </div>
    </div>
    <div id="aboutMe">
...
.newProduct0{
  color: white;
  margin-top: 175px;/*这个多出来55px本来量的是12px*/
  margin-bottom: 0px;
}
.newProduct1{
  margin-top: 10px;
...
.newProduct2{
  ...
  #newPage ul li:first-child{
    margin-left: 400px;
    text-align: center;
  }
  #newPage ul > :first-child + li{
    margin-left: 168px;
  }
  #newPage ul li:last-child{
    margin-left: 186px;
  }
  .compute{
    width: 330px;
