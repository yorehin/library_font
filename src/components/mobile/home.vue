<template>
  ...
  <div>
    ...
    <div class="testBack" >
      ...
      <div class="newProduct0" style="color: white; padding-top: 16px">最新产品</div>
      <div class="newProduct1" style="color: white;">
        <div class="newProduct2" style="color: white; border-top: 1px solid white;">
          New Product
        </div>
      </div>
