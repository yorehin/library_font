  ...
  <div>
    ...
    <div class="main">
      <div class="box0" id="service-app">
        <h1>手机APP设计开发</h1>
        <div class="div-img"><img id="myApp" src="../../assets/img/service/service_app.png" height="93" width="93"/></div>
        <h3>创建属于自己的APP  》</h3>
        <h2>1、APP用户增长速度快、经济能力强，思维活跃。<br>
          2、APP可整合LBS、QR、AR等新技术，带给用户前所未有的用户体验。<br>
          3、APP基于手机的随时随身性、互动性特点，容易通过微博、SNS等方式分享和传播，实现裂变式增长。<br>
          4、APP的开发成本，相比传统营销手段成本更低。<br>
      ...
      <div class="box0" id="service-Wechat">
        <h1>小程序开发设计</h1>
        <div class="div-img"><img id="wechat" src="../../assets/img/service/service_wechat.png" height="93" width="93"/></div>
        <h3>创建属于自己的小程序</h3>
        <h2>1、小程序是企业实现互联网+以及转型新零售的最佳选择，企业不需要组建单独的IT部门，甚至不需要雇佣单独的IT方面的人才，不需要买大型的服务器，不需要专门开发原生APP。只要到微信公众平台注册一个帐号，之后提交认证的相关资料，就可以根据自己企业的需要，着手定制一个完全不逊色于原生APP体验的微信小程序。<br>
          2、小程序可以降低企业触网的难度，在研发小程序这款产品的时候，把小程序的开发成本降至最低，而且微信是横跨Android和IOS两大系统的超级APP，在开发一个小程序时，完全不需要像研发原生app那样去做适配，这样就为企业省去很多的麻烦。<br>
          3、微信是中国月活用户量最大用户活跃度最高的社交网络，小程序完全可以借助强大的社交网络来获客，有效地降低获客成本，从而降低企业的经营成本。
        </h2>
      </div>
      <div class="box0" style="margin-top: 236px" id="service-web">
        <h1>WEB网站设计开发</h1>
        <div class="div-img"><img id="myWeb" src="../../assets/img/service/service_web.png" height="93" width="93"/></div>
        <h3>创建属于自己的网站</h3>
      ...
      <div class="box0" id="service-pc">
        <h1>PC客户端设计开发</h1>
        <div class="div-img"><img id="myPc" src="../../assets/img/service/service_pc.png" height="93" width="93"/></div>
        <h3>创建属于自己的PC客户端</h3>
        <h2>1、稳定性能高。企业只要将显卡插入电脑主机，安装好电脑分机，多个电脑，可运行相同或不同程序，互不干扰，处理速度不受影响。<br>
          2、独立性能好。每个企业的网络连接一般为局域网络连接，PC端应用可单独作为企业使用各类应用软件局域性软件应用。使用局域网可以完整地将企业内部的任何共享资源得以企业内部共享，同时也可以独立的拷贝资料和传输文件。<br>
          3、读取速度快。独立的局域网络模式还可增加读取效能，为企业的业务处理与管理，提供了更好的执行效率。<br>
          4、保密性强。<br>
      ...
      <div class="box0" style="margin-top: 218px; margin-bottom: 0" id="service-custom">
        <h1>定制软件设计与开发</h1>
        <div class="div-img"><img id="myCustom" src="../../assets/img/service/service_custom.png" height="93" width="93"/></div>
        <h2>1、根据客户需要。<br>
          2。软硬件结合。</h2>
