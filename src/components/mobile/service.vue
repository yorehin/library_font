  ...
  <div>
    ...
    <div class="main">
      <div class="box0" id="service-app">
        <h1>手机APP设计开发</h1>
        <div class="div-img"><img src="../../assets/img/service/产品服务-APP.png" height="93" width="93"/></div>
        <h3>创建属于自己的APP  》</h3>
      ...
      <div class="box0" id="service-Wechat">
        <h1>小程序开发设计</h1>
        <div class="div-img"><img src="../../assets/img/service/产品服务-小程序.png" height="93" width="93"/></div>
        <h3>创建属于自己的小程序</h3>
      ...
      <div class="box0" style="margin-top: 236px" id="service-web">
        <h1>WEB网站设计开发</h1>
        <div class="div-img"><img src="../../assets/img/service/产品服务-WEB网站.png" height="93" width="93"/></div>
        <h3>创建属于自己的网站</h3>
      ...
      <div class="box0" id="service-pc">
        <h1>PC客户端设计开发</h1>
        <div class="div-img"><img src="../../assets/img/service/产品服务-PC客户端.png" height="93" width="93"/></div>
        <h3>创建属于自己的PC客户端</h3>
      ...
      <div class="box0" style="margin-top: 218px; margin-bottom: 0" id="service-custom">
        <h1>定制软件设计与开发</h1>
        <div class="div-img"><img src="../../assets/img/service/产品服务-软件定制.png" height="93" width="93"/></div>
        <h2>1、根据客户需要。<br>
          2。软硬件结合。</h2>
